...
Over the years, I've been attempting write more frequently (mostly notes to self) and put together all the past posts in one place, but something in this process fails and I can't keep up. So this time around, I trying again but with a much minimalistic and low-maintenance web tech that I've come to love so much; [Jekyll](http://jekyllrb.com). Small + clean code base, simple to build + serve locally, open-source and mostly importantly static!

All along, I've been learning from plenty of failures and some successes. I have ton of new material I wish to document in this blog - lessons from starting-up, working in other startups/GICs, research (academic in specific), code (CV, NLU, DL/ML) and other interesting stuff. Some of the oler post that I could restore are here as well.
